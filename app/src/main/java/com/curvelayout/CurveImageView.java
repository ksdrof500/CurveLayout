...
public class CurveImageView extends ImageView {
    ...
    private int gradientStartColor = Color.TRANSPARENT;
    private int gradientEndColor = Color.TRANSPARENT;

    private int curvatureDirection = CurvatureDirection.OUTWARD;
